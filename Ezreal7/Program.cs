...
namespace Ezreal7
{
    internal class Program
    {
            ...
            if (sender is Obj_AI_Turret && sender.Distance(Player.Instance) < 800 && sender.IsAlly)
            {
                ...
                Chat.Print("sender detected");
                    ...
                    
                    {
                        ...
                        Chat.Print("The target is : " + Prediction.Health.GetPrediction(Minion, 945 * (int)(Minion.Distance(sender.Position)/750)) + (int)(AMinions.Count * -5) );
                        
 
				if(Prediction.Health.GetPrediction(Minion, 945 * (int)(Minion.Distance(sender.Position)/750)) + (int)(AMinions.Count * -5) > Player.Instance.TotalAttackDamage &&  Prediction.Health.GetPrediction(Minion, 945 * (int)(Minion.Distance(sender.Position)/750)) + (int)(AMinions.Count * -5) <= sender.TotalAttackDamage * 1.25)
				 {   
				    Chat.Print("LH");
        ...
        public static void Harass()
        {
            ...
            if (useQ && Player.Instance.ManaPercent >= ManaQ && Q.IsReady())
            {
                if (Selector != null)
                {
            ...
            if (useW && Player.Instance.ManaPercent >= ManaW && W.IsReady())
            {
                if (Selector != null)
                {
        ...
        public static void AutoHarass()
        {
            ...
            if (useQ && Q.IsReady() && automana <= Player.Instance.ManaPercent && !Tru() && !Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Combo) && !Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Harass))
            {
                if (Selector != null)
                {
            ...
            if (useW && W.IsReady() && automanaw <= Player.Instance.ManaPercent && !Tru() && !Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Combo) && !Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Harass))
            {
                if (Selector != null)
                {
