...
namespace Talon7
{
    internal class Program
    {
        ...
        public static Menu Menu, ComboMenu, HarassMenu, LaneClearMenu, JungleClearMenu, Misc, KillStealMenu;
        ...
        static void OnLoadingComplete(EventArgs args)
        {
                ...
                ComboMenu.Add("you", new CheckBox("Use [YOUMUU]"));
        ...
        public static void Combo()
        {
            ...
            var you = ComboMenu["you"].Cast<CheckBox>().CurrentValue;
            ...
            if (target != null)
            {
                ...
                if (useR && R.IsReady() && target.IsValidTarget(250))
                {
                    R.Cast();
                }
        ...
        public static void AutoR()
        {
            ...
            var Enemies = ObjectManager.Player.Position.CountEnemiesInRange(800);
            if (useR && R.IsReady())
            {
        ...
        public static void LastHit()
        {
            ...
            if (Player.Instance.ManaPercent > mana)
            {
                ...
                if (useW && W.IsReady() && minions.IsValidTarget(700))
                {
                    W.Cast(minions);
                }
            }
